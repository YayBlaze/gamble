...
declare const Confetti: import("svelte").Component<{
    ...
    /**
     * The X multipliers of the distance between which the pieces will fly horizontally
     */
    x?: [number, number] | undefined;
    /**
     * The X multipliers of the distance between which the pieces will fly vertically
     */
    ...
    /**
     * If the effect should be shaped like a cone
     */
