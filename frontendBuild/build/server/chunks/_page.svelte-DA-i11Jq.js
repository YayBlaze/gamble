...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<!--]--> <div id="machine" class="rounded-[15px] m-auto dark:bg-(--grey) bg-(--light-grey) w-[100%] h-fit p-[2%] flex flex-row justify-between"><div class="box svelte-yxrulg">${escape_html(one)}</div> <div class="box svelte-yxrulg">${escape_html(two)}</div> <div class="box svelte-yxrulg">${escape_html(three)}</div></div> `;
  {
    $$payload.out += "<!--[!-->";
  }
...
//# sourceMappingURL=_page.svelte-DA-i11Jq.js.map
